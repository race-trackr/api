    ...
    endpoints: {
      ...
      countries: {
        ...
        show: {
          ...
          auth: false,
          response:
            '{ id, name, slug, iso, timezone, capital, tracks: [...], createdAt, updatedAt }',
        },
        create: {
          method: 'POST',
          path: '/api/countries',
      ...
      trackDays: {
        list: {
          ...
          response:
            '[{ id, userId, trackId, userVehicleId, date, weather, airTemperature, trackTemperature, trackCondition, note, bestLapTime, totalLaps, totalDistance, track: {...}, vehicle: {...}, tests: [...], createdAt, updatedAt }]',
        },
        show: {
          method: 'GET',
        ...
        create: {
          ...
          body: {
            ...
            tests:
              'array (optional): [{ category, parameter, value, lapTime, feedback, position }]',
          },
        },
        update: {
          method: 'PUT',
...
router
  .group(() => {
    // Administration des circuits (super_admin uniquement)
    ...
    // Administration des pays (super_admin uniquement)
  ...
  .prefix('/api')
  .use([middleware.auth(), middleware.super_admin()])
